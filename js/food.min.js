...
function importData(e, a) {
    ...
    for (var i in e.chefs) {
        e.chefs[i].originalEquip = e.chefs[i].equip;
        e.chefs[i].originalEquipId = e.chefs[i].equipId;
        e.chefs[i].originalEquipDisp = e.chefs[i].equipDisp;
        e.chefs[i].originalDiskAmbers = JSON.parse(JSON.stringify(e.chefs[i].disk.ambers));
        e.chefs[i].originalDiskLevel = e.chefs[i].disk.level;
    }
