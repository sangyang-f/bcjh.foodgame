...
function initDecorationTable(e) {
    ...
    // 添加表头
    var headerContent = '<span style="display:inline-block;width:40px;text-align:left;font-weight:bold;">排名</span>' +
                       '<span style="display:inline-block;width:120px;text-align:left;font-weight:bold;">套装名称</span>' +
    ...
    for (var i = 0; i < suitsWithRank.length; i++) {
        ...
        if (e.suits[o].totalRAvgEff && e.suits[o].totalRAvgEff > 0) {
            ...
            var contentHtml = '<span style="display:inline-block;width:40px;text-align:left;">' + suitData.rank + '</span>' +
                            '<span style="display:inline-block;width:120px;text-align:left;">' + suitName + '</span>' +
