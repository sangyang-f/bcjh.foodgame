...
function calculateGuestRateFields(custom, rule, starLevel, quantity, qualityLevel) {
    ...
    // 统计 特技符文率(GuestAntiqueDropRate) 技能数量
    var guestAntiqueDropRateCount = 0;
    ...
    // 如果有 GuestAntiqueDropRate 技能，并且品级大于等于特级（3）
    if (guestAntiqueDropRateCount > 0 && parseInt(qualityLevel) >= 3) {
        // 在默认符文率基础上，加 10% * 技能数量
        var runeRateIncrease = 10 * guestAntiqueDropRateCount;
